...
all: force_vector.o unit_num.o main.o clear_term.o convert.o point.o system.o numerical.o
...
test: force_vector.o unit_num.o test.o clear_term.o convert.o point.o system.o numerical.o
	@echo linking executable
	@g++ $^ -o test $(INCLUDES)

test.o: test.cpp convert.o hash.h
	@echo compiling test
...
force_vector.o: force_vector.cpp force_vector.h convert.o numerical.o
...
numerical.o: numerical.h numerical.cpp
	@echo compiling numerical
	@g++ -c numerical.cpp $(INCLUDES)
